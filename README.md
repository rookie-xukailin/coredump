...
python3 tools/export_skill.py     # 产出 dist/swrd-skill-coredump-analyze/ 和 dist/*-v3.3.0.zip
unzip dist/swrd-skill-coredump-analyze-v3.3.0.zip -d ~/.codebuddy/skills/
```

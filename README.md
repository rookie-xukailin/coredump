...
python3 tools/export_skill.py     # 产出 dist/swrd-skill-coredump-analyze/ 和 dist/*-v3.12.1.zip
unzip dist/swrd-skill-coredump-analyze-v3.12.1.zip -d ~/.codebuddy/skills/
```
